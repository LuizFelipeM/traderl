...
class GradientPolicy(nn.Module):
    def __init__(
        ...
        *,
        ...
        n_actions: np.int32,
        hidden_size: tuple[np.int32, np.int32] = (np.int32(128), np.int32(64)),
        ...
        self.input_layer = nn.Linear(in_features.item(), hidden_size[0].item())
        self.hidden_layer = nn.Linear(hidden_size[0].item(), hidden_size[1].item())
        self.output_layer = nn.Linear(hidden_size[1].item(), n_actions.item())
